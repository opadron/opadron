...
" StatusLine: {{{2
hi StatusLine  guifg=#000000 ctermfg=0 guibg=#C6DEFF ctermbg=189 gui=NONE
...
hi NonText  guifg=#7A705A ctermfg=253 guibg=#FFFFFF ctermbg=15
hi SpecialKey  guifg=#7A705A ctermfg=253 guibg=#FFFFFF ctermbg=15
